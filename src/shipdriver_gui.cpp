...
ShipDriverBase::ShipDriverBase(wxWindow* parent, wxWindowID id,
  ...
  m_buttonAuto = new wxButton(this, wxID_ANY, _("Auto"), wxDefaultPosition,
                              wxDefaultSize, 0);
  m_buttonAuto->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                               wxFONTWEIGHT_BOLD, false, wxT("Arial")));
  ...
  m_buttonWind = new wxButton(this, wxID_ANY, _("Sail"), wxDefaultPosition,
                              wxDefaultSize, 0);
  m_buttonWind->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                               wxFONTWEIGHT_BOLD, false, wxT("Arial")));
  ...
  m_buttonMinus1 = new wxButton(this, wxID_ANY, _("-1"), wxDefaultPosition,
                                wxDefaultSize, 0);
  m_buttonMinus1->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                                 wxFONTWEIGHT_BOLD, false, wxT("Arial")));
  m_buttonMinus1->SetMinSize(wxSize(50, -1));

  fgSizer82->Add(m_buttonMinus1, 1, wxALL | wxEXPAND, 2);

  m_buttonMinus10 = new wxButton(this, wxID_ANY, _("-10"), wxDefaultPosition,
                                 wxDefaultSize, 0);
  m_buttonMinus10->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                                  wxFONTWEIGHT_BOLD, false, wxT("Arial")));
  m_buttonMinus10->SetMinSize(wxSize(50, -1));

  fgSizer82->Add(m_buttonMinus10, 1, wxALL | wxEXPAND, 2);

  m_buttonPlus10 = new wxButton(this, wxID_ANY, _("+10"), wxDefaultPosition,
                                wxDefaultSize, 0);
  m_buttonPlus10->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                                 wxFONTWEIGHT_BOLD, false, wxT("Arial")));
  m_buttonPlus10->SetMinSize(wxSize(50, -1));

  fgSizer82->Add(m_buttonPlus10, 1, wxALL | wxEXPAND, 2);

  m_buttonPlus1 = new wxButton(this, wxID_ANY, _("+1"), wxDefaultPosition,
                               wxDefaultSize, 0);
  m_buttonPlus1->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                                wxFONTWEIGHT_BOLD, false, wxT("Arial")));
  ...
  sbSizer3 = new wxStaticBoxSizer(new wxStaticBox(this, wxID_ANY, _("Alarms")),
                                  wxVERTICAL);
  ...
  m_buttonSART =
      new wxToggleButton(sbSizer3->GetStaticBox(), wxID_ANY, _("SART"),
                         wxDefaultPosition, wxDefaultSize, 0);
  m_buttonSART->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                               wxFONTWEIGHT_NORMAL, false, wxT("Arial")));
  ...
  m_buttonMOB = new wxToggleButton(sbSizer3->GetStaticBox(), wxID_ANY, _("MOB"),
                                   wxDefaultPosition, wxDefaultSize, 0);
  m_buttonMOB->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                              wxFONTWEIGHT_NORMAL, false, wxT("Arial")));
  ...
  m_buttonEPIRB =
      new wxToggleButton(sbSizer3->GetStaticBox(), wxID_ANY, _("EPIRB"),
                         wxDefaultPosition, wxDefaultSize, 0);
  m_buttonEPIRB->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                                wxFONTWEIGHT_NORMAL, false, wxT("Arial")));
  ...
  m_buttonDistressAlert = new wxToggleButton(
      sbSizer3->GetStaticBox(), wxID_ANY, _("DSC Distress Alert"),
      wxDefaultPosition, wxDefaultSize, 0);
  m_buttonDistressAlert->SetFont(wxFont(12, wxFONTFAMILY_SWISS,
  ...
  m_buttonDistressCancel = new wxToggleButton(
      sbSizer3->GetStaticBox(), wxID_ANY, _("DSC Distress Cancel"),
      wxDefaultPosition, wxDefaultSize, 0);
  m_buttonDistressCancel->SetFont(
      wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL,
             false, wxT("Arial")));
  ...
  m_buttonDistressRelay = new wxToggleButton(
      sbSizer3->GetStaticBox(), wxID_ANY, _("Distress Relay"),
      wxDefaultPosition, wxDefaultSize, 0);
  m_buttonDistressRelay->SetFont(wxFont(12, wxFONTFAMILY_SWISS,
                                        wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL,
                                        false, wxT("Arial")));
  ...
  m_buttonRelayCancel =
      new wxToggleButton(sbSizer3->GetStaticBox(), wxID_ANY, _("Relay Cancel"),
                         wxDefaultPosition, wxDefaultSize, 0);
  m_buttonRelayCancel->SetFont(wxFont(12, wxFONTFAMILY_SWISS,
                                      wxFONTSTYLE_NORMAL, wxFONTWEIGHT_NORMAL,
                                      false, wxT("Arial")));
  ...
  m_buttonCollision = new wxToggleButton(sbSizer3->GetStaticBox(), wxID_ANY,
                                         _("AIS Collision Warning"),
                                         wxDefaultPosition, wxDefaultSize, 0);
  m_buttonCollision->SetFont(wxFont(12, wxFONTFAMILY_SWISS, wxFONTSTYLE_NORMAL,
                                    wxFONTWEIGHT_NORMAL, false, wxT("Arial")));
  ...
  this->Connect(wxEVT_CLOSE_WINDOW,
                wxCloseEventHandler(ShipDriverBase::OnClose));
  this->Connect(wxEVT_LEFT_DCLICK,
                wxMouseEventHandler(ShipDriverBase::OnDLeftClick));
  m_buttonMid->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                       wxCommandEventHandler(ShipDriverBase::OnMidships), NULL,
                       this);
  m_bpPlay->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                    wxCommandEventHandler(ShipDriverBase::OnStart), NULL, this);
  m_bpStop->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                    wxCommandEventHandler(ShipDriverBase::OnStop), NULL, this);
  m_buttonPause->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                         wxCommandEventHandler(ShipDriverBase::OnPause), NULL,
                         this);
  m_buttonStandby->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                           wxCommandEventHandler(ShipDriverBase::OnStandby),
                           NULL, this);
  m_buttonAuto->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                        wxCommandEventHandler(ShipDriverBase::OnAuto), NULL,
                        this);
  m_button7->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                     wxCommandEventHandler(ShipDriverBase::OnFollow), NULL,
                     this);
  m_buttonWind->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                        wxCommandEventHandler(ShipDriverBase::OnWind), NULL,
                        this);
  m_buttonMinus1->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(ShipDriverBase::OnMinus1), NULL,
                          this);
  m_buttonMinus10->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                           wxCommandEventHandler(ShipDriverBase::OnMinus10),
                           NULL, this);
  m_buttonPlus10->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(ShipDriverBase::OnPlus10), NULL,
                          this);
  m_buttonPlus1->Connect(wxEVT_COMMAND_BUTTON_CLICKED,
                         wxCommandEventHandler(ShipDriverBase::OnPlus1), NULL,
                         this);
  m_buttonSART->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                        wxCommandEventHandler(ShipDriverBase::OnSART), NULL,
                        this);
  m_buttonMOB->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                       wxCommandEventHandler(ShipDriverBase::OnMOB), NULL,
                       this);
  m_buttonEPIRB->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                         wxCommandEventHandler(ShipDriverBase::OnEPIRB), NULL,
                         this);
  m_buttonDistressAlert->Connect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(ShipDriverBase::OnDistressAlert), NULL, this);
  m_buttonDistressCancel->Connect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(ShipDriverBase::OnDistressCancel), NULL, this);
  m_buttonDistressRelay->Connect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(ShipDriverBase::OnDistressRelay), NULL, this);
  m_buttonRelayCancel->Connect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(ShipDriverBase::OnRelayCancel), NULL, this);
  m_buttonCollision->Connect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                             wxCommandEventHandler(ShipDriverBase::OnCollision),
                             NULL, this);
}
...
ShipDriverBase::~ShipDriverBase() {
  ...
  m_buttonMid->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                          wxCommandEventHandler(ShipDriverBase::OnMidships),
                          NULL, this);
  m_bpPlay->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                       wxCommandEventHandler(ShipDriverBase::OnStart), NULL,
                       this);
  m_bpStop->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                       wxCommandEventHandler(ShipDriverBase::OnStop), NULL,
                       this);
  m_buttonPause->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                            wxCommandEventHandler(ShipDriverBase::OnPause),
                            NULL, this);
  m_buttonStandby->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                              wxCommandEventHandler(ShipDriverBase::OnStandby),
                              NULL, this);
  m_buttonAuto->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                           wxCommandEventHandler(ShipDriverBase::OnAuto), NULL,
                           this);
  m_button7->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                        wxCommandEventHandler(ShipDriverBase::OnFollow), NULL,
                        this);
  m_buttonWind->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                           wxCommandEventHandler(ShipDriverBase::OnWind), NULL,
                           this);
  m_buttonMinus1->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                             wxCommandEventHandler(ShipDriverBase::OnMinus1),
                             NULL, this);
  m_buttonMinus10->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                              wxCommandEventHandler(ShipDriverBase::OnMinus10),
                              NULL, this);
  m_buttonPlus10->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                             wxCommandEventHandler(ShipDriverBase::OnPlus10),
                             NULL, this);
  m_buttonPlus1->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED,
                            wxCommandEventHandler(ShipDriverBase::OnPlus1),
                            NULL, this);
  m_buttonSART->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                           wxCommandEventHandler(ShipDriverBase::OnSART), NULL,
                           this);
  m_buttonMOB->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                          wxCommandEventHandler(ShipDriverBase::OnMOB), NULL,
                          this);
  m_buttonEPIRB->Disconnect(wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
                            wxCommandEventHandler(ShipDriverBase::OnEPIRB),
                            NULL, this);
  m_buttonDistressAlert->Disconnect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(ShipDriverBase::OnDistressAlert), NULL, this);
  m_buttonDistressCancel->Disconnect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(ShipDriverBase::OnDistressCancel), NULL, this);
  m_buttonDistressRelay->Disconnect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(ShipDriverBase::OnDistressRelay), NULL, this);
  m_buttonRelayCancel->Disconnect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(ShipDriverBase::OnRelayCancel), NULL, this);
  m_buttonCollision->Disconnect(
      wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,
      wxCommandEventHandler(ShipDriverBase::OnCollision), NULL, this);
}

shipdriverPreferences::shipdriverPreferences(wxWindow* parent, wxWindowID id,
  ...
  sbSizer41 = new wxStaticBoxSizer(
      new wxStaticBox(sbSizer1->GetStaticBox(), wxID_ANY, _("Sail")),
      wxVERTICAL);

  m_buttonPolarBrowse =
      new wxButton(sbSizer41->GetStaticBox(), wxID_ANY, _("Choose Polar File"),
                   wxDefaultPosition, wxDefaultSize, 0);
  sbSizer41->Add(m_buttonPolarBrowse, 0, wxALL, 5);

  m_textCtrlPolarFile =
      new wxTextCtrl(sbSizer41->GetStaticBox(), wxID_ANY, wxEmptyString,
                     wxDefaultPosition, wxDefaultSize, 0);
